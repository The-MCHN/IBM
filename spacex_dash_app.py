...
def get_payload_slider(entered_site, payload_value):
    filtered_df = spacex_df
    if entered_site == 'ALL':      
        ...
        filtered_df=filtered_df[(filtered_df['Launch Site']==entered_site)  & (filtered_df['Payload Mass (kg)']>payload_value[0]) & (filtered_df['Payload Mass (kg)']<payload_value[1])]
